...
export const easeInCirc = (t: number) => {
	const scaledTime = t / 1;
	return -1 * (Math.sqrt(1 - scaledTime * t) - 1);
};

// Start fast, decreasing velocity until stop
export const easeOutCirc = (t: number) => {
	const t1 = t - 1;
...
export const easeInBack = (t: number, magnitude = 1.70158) => {
	return t * t * ((magnitude + 1) * t - magnitude);
};

// Fast snap to backwards point then slow resolve to finish
export const easeOutBack = (t: number, magnitude = 1.70158) => {
...
export const easeInOutBack = (t: number, magnitude = 1.70158) => {
	const scaledTime = t * 2;
...
export const easeInElastic = (t: number, magnitude = 0.7) => {
	if (t === 0 || t === 1) {
		return t;
	}
...
export const easeOutElastic = (t: number, magnitude = 0.7) => {
	if (t === 0 || t === 1) return t;
...
export const easeInOutElastic = (t: number, magnitude = 0.65) => {
	if (t === 0 || t === 1) return t;
...
export const easeInBounce = (t: number) => {
